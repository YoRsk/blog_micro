...
const BlogList = () => {
  const BLOG_API_URL = `${process.env.NEXT_PUBLIC_BLOG_SERVICE_URL}/blogsIndex`;
                          ...
                          <div className="eleven wide column">
                              ...
                              <div className="ui grid">
                                  ...
                                  <div className="right aligned five wide column">
                                      <span className="ui teal basic label m-padded-tiny m-text-thin">{blog.type.name}</span>
                                  </div>
                              </div>
                          </div>
